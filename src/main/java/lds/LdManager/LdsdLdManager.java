...
//    }
    ...
    public void loadIndexes() throws Exception {
        ...
        String outgoingEdgesIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/outgoingEdges_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String objectsIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/objects_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String countShareCommonObjectsIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/countShareCommonObjects_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String countShareCommonSubjectsIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/countShareCommonSubjects_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String countShareTyplessCommonObjectsIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/countShareTyplessCommonObjects_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String countShareTyplessCommonSubjectsIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/countShareTyplessCommonSubjects_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String directlyConnectedIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/directlyConnected_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String countResourcesIndexFile = System.getProperty("user.dir") + "/Indexes/LDSD/countResources_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
