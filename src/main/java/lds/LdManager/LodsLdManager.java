 ...
 */
public class LodsLdManager extends FeaturesMaesuresLdManager{   
    ...
    public LodsLdManager(LdDataset dataset , boolean useIndex) {
        super(dataset);
    ...
    public void loadIndexes() throws Exception{
        ...
        String ontologiesIndexFile = System.getProperty("user.dir") + "/Indexes/LODS/ontologies_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
        String augmentedOntologiesIndexFile = System.getProperty("user.dir") + "/Indexes/LODS/augmented_ontologies_index_" + dataset.getName().toLowerCase().replace(" ", "_") + ".db";
