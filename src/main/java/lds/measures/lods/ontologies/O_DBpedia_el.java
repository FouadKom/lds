 ...
 */
public class O_DBpedia_el extends O_DBpedia {
    
    private List<String> namespacesInitial = Arrays.asList("\"http://el.dbpedia.org/resource/\"");
    private List<String> namespacesAugmentation = super.namespaces;
    private String endpointURI = "https://el.dbpedia.org/sparql";
   ...
   @Override
    ...
    public boolean equals(Object o){
        ...
        return ontology.toString().equals("DBpedia_el");
