 ...
 */
public class EPICS_v1 implements LdSimilarity{
    private EpicsLdManager ldManager;
    private boolean useIndeses;
    private int NumberOfResources;
    private Conf config;
    
    public EPICS_v1(Conf config) throws Exception{
	...
	double sim = 0;
        ...
        try {
            ...
            Logger.getLogger(EPICS_v1.class.getName()).log(Level.SEVERE, null, ex);
        }
