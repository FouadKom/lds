...
public class WPICSTest {
    ...
    public void WPICSTest() throws Exception{
       ...
       /* Conf config = new Conf();
        ...
        R r1 = new R("http://dbpedia.org/resource/Inception");
        R r2 = new R("http://dbpedia.org/resource/Manhattan");
